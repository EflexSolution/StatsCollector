// src/lib.rs
/*
 * Core library for StatsCollector
 */
...
#[derive(Debug)]
pub struct StatsCollectorProcessor {
    verbose: bool,
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting StatsCollector processing");
    
    let mut processor = StatsCollectorProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = StatsCollectorProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = StatsCollectorProcessor::new(false);
